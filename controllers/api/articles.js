...
router.get('/scrape', function(req, res, next) {
    // request('http://www.utahutes.com/archives.aspx?path=football', function(error, response, html) {
    request('https://www.blocku.com/', function(error, response, html) {
        let $ = cheerio.load(html);
        let results = [];
        $('.c-entry-box--compact__title').each(function(i, e) {
